  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-neutral-700/80 backdrop-blur-lg">
      <div className="container relative">
        ...
        {/* Mobile Menu Drop */}
        {mobileOpen && (
          <div className="absolute right-0 z-50 bg-white w-full pb-0 flex flex-col justify-center items-center lg:hidden top-full dark:bg-neutral-900 boder-b border-neutral-700 mt-1 ">
            <ul className="w-full">
              {navItems.map((item, index) => (
                <li
                  key={index}
